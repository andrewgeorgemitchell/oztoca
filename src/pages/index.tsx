      ...
      <Grid item xs={12} style={{ alignSelf: `center` }}>
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} md={6} container spacing={3}>
            ...
            <Grid item xs={12}>
              <Typography>
                Raised on a farm and breeding beautiful cats since 2005, animals
                have always been a large part of my life. As a member of the CFA
                breed council, I breed healthy and lovable American Bobtails,
                guaranteed.
              </Typography>
            </Grid>
            <Grid item xs={12}>
              <Typography>
                ...
                physical features of the American Bobtail sets this breed apart
                from other cats.
              </Typography>
            </Grid>
            <Grid item xs={12}>
              <Typography>
                ...
                train and eager to please. They are also extremely interactive,
                following you around from room to room and playing fetch with a
                ball.
              </Typography>
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <Typography>
                ...
                ensure their health and happiness, in turn offering satisfaction
                to my clients. I am committed to providing a good experience for
                everyone.
              </Typography>
            </Grid>
            <Grid item xs={12}>
          ...
          <Grid item xs={12} md={6} container spacing={3}>
            ...
            <Grid item xs={12}>
              <Typography>
                American Bobtail lovers say you should take a look at their cat
                instead.
              </Typography>
            </Grid>
            ...
            <Grid item xs={12}>
              <Typography>
                He’s a lover with a heart of gold who is devoted to his people,
                follows them around, loves to play, walks nicely on a leash
                (after training, of course), and welcomes guests with a purr.
                This is a smart cat who enjoys puzzle toys, learning tricks, and
                playing fetch.
              </Typography>
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <Typography>
                ...
                companion and suited to a variety of lifestyles, from relaxed to
                rowdy.
              </Typography>
            </Grid>
          </Grid>
